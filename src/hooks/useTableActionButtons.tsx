...
export interface TableActionButtonsHookProps extends Pick<EntityTableEditParams<any>, 'addModalParams' | 'isEditable'>{
...
export const useTableActionButtons = (props: TableActionButtonsHookProps) => {
    ...
    }, [isEditable, setIsEditable, addModalParams, handleAdd, handleRemove, handleCancel]);
}
