...
import {ColumnDataType, CustomTableParams, Offer} from "@types";
...
export interface OfferListProps extends CustomTableParams<Offer> {
}

export const OfferList: React.FC<OfferListProps> = (props) => {
